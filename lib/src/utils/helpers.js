  ...
  image: [
    {
      ...
      files: [
        { filename: "image1_thumbnail.jpg", url: "https://example.com/image1_thumbnail.jpg" }
      ]
    },
    {
      media_id: "img2",
      ...
      files: [
        { filename: "image2_thumbnail.jpg", url: "https://example.com/image2_thumbnail.jpg" }
      ]
    },
    {
      media_id: "img3",
      ...
      files: [
        { filename: "image3_thumbnail.jpg", url: "https://example.com/image3_thumbnail.jpg" }
      ]
    }
  ],
...
export const populateWithDummyValues = (obj, presets) => {
  if (Array.isArray(obj)) {
    return obj.map(item => populateWithDummyValues(item, presets));
