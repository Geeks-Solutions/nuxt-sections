...
module.exports = async function (moduleOptions) {
  ...
  nuxt.hook('i18n:extend-messages', function (additionalMessages) {
    additionalMessages.push({
      en: {
        ...
        "fillRequiredFields": "You must fill your required fields and create a whitelist before submitting your data.",
      ...
      fr: {
        ...
        "fillRequiredFields": "Vous devez remplir les champs requis et créer une whitelist avant de soumettre vos données.",
  ...
  if(this.options.publicRuntimeConfig.sections && this.options.publicRuntimeConfig.sections.pathToDynamicPage) {
    pathPrefix = this.options.publicRuntimeConfig.sections.pathToDynamicPage
  }

  this.extendRoutes((routes, resolve) => {
    routes.push({
      name: 'dynamic-page',
      path: `${pathPrefix}/:pageName`, // Customize the route path as per your requirements
