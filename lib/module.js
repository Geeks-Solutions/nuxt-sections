...
module.exports = async function (moduleOptions) {
      ...
      en: {
        ...
        "mediaComponent": {
          ...
          "EditMedia": {
            ...
            "updateMediaAgain": "If this is the media used by your section, make sure to select the media again to have the updated preview"
          },
          "table": {
            "filterBy": "Filter by:",
      ...
      fr: {
        ...
        "mediaComponent": {
          ...
          "EditMedia": {
            ...
            "updateMediaAgain": "Si c'est le média utilisé par votre section, sélectionner le média de nouveau pour avoir l'aperçu mis á jour"
          },
          "table": {
  ...
  this.addModule('@eweev/apps-bo-public/nuxt');
  this.options.css.push('@eweev/apps-bo-public/assets/icons/icomoon/style.css')
