...
module.exports = async function (moduleOptions) {
    ...
    additionalMessages.push({
      en: {
        ...
        intro: {
          ...
          inventory: "The inventory lists all the sections types that you can enabled for your project so they become available for you to add to your pages, Let's check it and activate a new section type",
          simpleCTA: "Enable this Section type to use it in your page, you can always disable it later",
          simpleCTAInstalled: "Now head back to the Available sections to add the new section type to your page",
          clickSimpleCTA: "Click `confirm` to add the section to your page",
      ...
      fr: {
        ...
        intro: {
          ...
          inventory: "L'inventaire répertorie tous les types de sections que vous pouvez activer pour votre projet afin qu'ils soient disponibles pour les ajouter à vos pages. Vérifions-le et activons un nouveau type de section",
          simpleCTA: "Activez ce type de section pour l'utiliser dans votre page, vous pouvez toujours le désactiver plus tard",
          simpleCTAInstalled: "Retournez maintenant aux sections disponibles pour ajouter le nouveau type de section à votre page",
          clickSimpleCTA: "Cliquez sur `confirmer` pour ajouter la section à votre page",
  ...
  // build dir (.nuxt/)
  const foldersToSync = ['src/components/Sections', 'src/components/Translations', 'src/components/Tooltip', 'src/components/Editor', 'src/components/Medias', 'src/components/SectionsViews', 'src/utils', 'src/configs/forms', 'src/configs/type-icons', 'src/configs/views', 'src/base/SubTypes', 'src/base/types', 'src/base/icons', 'src/base/assets']
