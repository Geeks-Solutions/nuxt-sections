...
module.exports = async function (moduleOptions) {
  ...
  nuxt.hook('i18n:extend-messages', function (additionalMessages) {
    additionalMessages.push({
      en: {
        ...
        "AddGlobal": "Add a global section",
        ...
        "success-global-section-title": "Congratulations, you just added a new global section that is editable by a content administrator",
        ...
        "delete-global-section-type": "Are you sure you want to delete this global section type: ",
        ...
        "updateSectionTypeError": "Couldn't update this globale section type: ",
        "globalTypeUpdated": "Global section update successfully",
        "referencedSection": "This section is referenced on the following pages: {pages}. Editing it will modify it on all these pages",
      ...
      fr: {
        ...
        "AddGlobal": "Ajouter une section globale",
        ...
        "success-global-section-title": "Félicitations, vous venez de créer une globale section modifiable par votre editeur de contenu",
        ...
        "delete-global-section-type": "Voulez-vous vraiment supprimer ce type de section globale: ",
        ...
        "updateSectionTypeError": "Impossible de modifier ce type de section globale: ",
        "globalTypeUpdated": "Mise à jour de la section globale réussie",
        "referencedSection": "Cette section est référencée sur les pages suivantes: {pages}. Le modifier le modifiera sur toutes ces pages",
  ...
  // build dir (.nuxt/)
  const foldersToSync = ['src/components/Sections', 'src/components/Translations', 'src/components/Editor', 'src/components/Medias', 'src/components/SectionsViews', 'src/utils', 'src/configs/forms', 'src/configs/type-icons', 'src/configs/views', 'src/base/SubTypes', 'src/base/types', 'src/base/icons', 'src/base/assets']
