...
module.exports = async function (moduleOptions) {
  ...
  // build dir (.nuxt/)
  const foldersToSync = ['src/components/Sections', 'src/components/Translations', 'src/utils', 'src/configs/forms', 'src/configs/type-icons', 'src/configs/views', 'src/base/SubTypes', 'src/base/types', 'src/base/icons', 'src/base/assets']
